...
def check_correctness_java(
    ...
    base_path = setup_base_path(current_dir, f"{language}_exec_eval", "", problem.get("task_id"), completion_id)
    try:
...
def check_correctness_csharp(
    ...
    cs_eval_dir = setup_base_path(current_dir, "cs_eval", "", problem.get("task_id"), completion_id)
